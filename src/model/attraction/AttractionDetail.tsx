...
export default function AttractionDetail({
  ...
  const price = attraction.isFree
    ? 'Miễn phí'
    : `${nf.format(Number(attraction.minPrice || 0))} – ${nf.format(
        Number(attraction.maxPrice || 0)
      )} đ`;
              ...
              <CardContent className="p-6 space-y-4">
                ...
                <div className="bg-gradient-to-r from-green-50 to-teal-50 p-4 rounded-2xl">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="font-medium text-green-800 mb-1">Địa chỉ chi tiết</p>
                      <p className="text-green-700 text-sm leading-relaxed">{addressStr}</p>
                    </div>
                  </div>
                </div>
              </CardContent>
              ...
              <CardContent className="p-6 space-y-6">
                ...
                <div className="bg-gradient-to-br from-blue-50 to-indigo-100 p-4 rounded-2xl">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-sm text-blue-600 font-medium">Giá vé tham quan</p>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex justify-between items-center p-3 bg-gray-50 rounded-xl">
                    ...
                    <span className="font-semibold text-gray-800">Quanh năm</span>
                  </div>
